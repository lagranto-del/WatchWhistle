  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      if (!error.message?.includes('canceled')) {
        alert('Sign in failed. Try Demo Account.'); 
      }
    }
  };
        ...
        <div style={{flex:1,display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',textAlign:'center',maxWidth:'900px',margin:'0 auto',position:'relative',zIndex:2}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'12px',width:'100%',maxWidth:'400px'}}>
            <button 
              ...
              style={{padding:'16px 32px',fontSize:'16px',display:'flex',alignItems:'center',justifyContent:'center',width:'100%',borderRadius:'50px',fontWeight:600,background:'#ef4444',color:'white',border:'none',cursor:'pointer'}}
            >
              <svg style={{marginRight:'8px'}} viewBox="0 0 24 24" width="20" height="20">
